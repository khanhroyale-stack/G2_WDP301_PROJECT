        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-6 py-16 md:grid-cols-2 md:py-24">
          <div>
            ...
            <h1 className="max-w-xl text-4xl font-black leading-tight tracking-tight md:text-6xl">
              Bán đồ cũ, đổi đồ mới, và <span className="text-emerald-600">kết nối cộng đồng</span>
            </h1>
            <p className="mt-5 max-w-xl text-lg leading-8 text-slate-600">
              Nền tảng dành cho sinh viên để bán hoặc đổi đồ đã qua sử dụng, thân thiện và gần gũi với cộng đồng.
            </p>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-6 py-10 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">Nền tảng bán, đổi đồ cũ thân thiện với cộng đồng.</p>
          </div>
